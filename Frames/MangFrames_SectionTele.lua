...
function MangAdmin:CreateTeleSection()
    ...
    FrameLib:BuildFontString({
        ...
        group = "tele",
        parent = ma_midframe,
        text = Locale["Tel_Continent_Selection"],
        setpoint = {
            pos = "TOPLEFT",
            offX = 5,
            offY = -10
    ...
    FrameLib:BuildButton({
        ...
        text = Locale["Tel_Eastern_Kingdoms_N"],
        size = {
            width = 181,
            height = 16
        },
        script = {{"OnShow", function()
    ...
    FrameLib:BuildButton({
        ...
        text = Locale["Tel_Eastern_Kingdoms_S"],
        size = {
            width = 181,
            height = 16
        },
    ...
    FrameLib:BuildButton({
        ...
        text = Locale["Tel_Northrend_Alliance"],
        size = {
            width = 181,
            height = 16
        },
    ...
    FrameLib:BuildButton({
        ...
        text = Locale["Tel_Northrend_Horde"],
        size = {
            width = 181,
            height = 16
        },
    ...
    FrameLib:BuildButton({
        ...
        text = Locale["Tel_Battlegrounds/Arenas"],
        size = {
            width = 181,
            height = 16
        },
    ...
    FrameLib:BuildButton({
        ...
        text = Locale["Tel_Instances: Eastern"],
        size = {
            width = 181,
            height = 16
        },
    ...
    FrameLib:BuildButton({
        ...
        text = Locale["Tel_Instances: Kalimdor"],
        size = {
            width = 181,
            height = 16
        },
    ...
    FrameLib:BuildButton({
        ...
        text = Locale["Tel_Instances: Outland"],
        size = {
            width = 181,
            height = 16
        },
    ...
    FrameLib:BuildButton({
        ...
        text = Locale["Tel_Instances: Northrend"],
        size = {
            width = 181,
            height = 16
        },
