    ...
    if zoneCount > -1 then
        ...
        for line = 1, 12 do
            ...
            if lineplusoffset <= zoneCount then
                ...
                getglobal("ma_ZoneScrollBarEntry" .. line):SetScript("OnEnter", function()
                    cont = MangAdmin.db.char.selectedCont
                end)
                getglobal("ma_ZoneScrollBarEntry" .. line):SetScript("OnLeave", function()
                    cont = MangAdmin.db.char.selectedCont
                end)
    ...
    if subzoneCount > 0 then
        ...
        for line = 1, 12 do
            ...
            if lineplusoffset <= subzoneCount then
                ...
                getglobal("ma_SubzoneScrollBarEntry" .. line):SetScript("OnClick", function()
                    MangAdmin:ChatMsg(teleobj.command)
                end)
                getglobal("ma_SubzoneScrollBarEntry" .. line):SetScript("OnEnter", function()
                    cont = MangAdmin.db.char.selectedCont
                end)
                getglobal("ma_SubzoneScrollBarEntry" .. line):SetScript("OnLeave", function()
                    cont = MangAdmin.db.char.selectedCont
                end)
