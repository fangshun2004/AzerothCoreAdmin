...
function GM_GMModeCommand(value)
    ...
    MangAdmin:LogAction(genericLogGenerator("logGM_GMMode", {
        ["value"] = value
    }))
end
...
function GM_createAccountCommand()
    ...
    MangAdmin:LogAction(genericLogGenerator("logGM_createAccountCompleted", {
        ["value"] = input
    }))
...
function GM_deleteAccountCommand()
    ...
    MangAdmin:LogAction(genericLogGenerator("logGM_deleteAccountCompleted", {
        ["value"] = input
    }))
    print(Locale["operationCompleted"])
end
...
function GM_setAccountGMLevelCommand()
    ...
    MangAdmin:LogAction(genericLogGenerator("logGM_setAccountGMLevelCompleted", {
        ["value"] = input
    }))
    print(Locale["operationCompleted"])
end
...
function GM_setAccountPasswordCommand()
    ...
    MangAdmin:LogAction(genericLogGenerator("logGM_setAccountPasswordCompleted", {
...
function GM_setAccountAddonCommand()
    ...
    MangAdmin:LogAction(genericLogGenerator("logGM_setAccountAddonCompleted", {
        ["value"] = input
    }))
    print(Locale["operationCompleted"])
end
...
function GM_instantKillModeCommand()
    ...
    MangAdmin:LogAction((GM_instantKillModeCheckBox:GetChecked() and Locale["genericEnabledText"] or
                            Locale["genericDisabledText"]) .. Locale["logGM_instantKillMode"])
end
...
function GM_setSpeedOrScaleCommand(sliderControl, sliderCommand)
    ...
    if commandTargetCheck() then
        ...
        MangAdmin:LogAction(getCommandTargetName() .. Locale[GM_genericCommands[sliderCommand][GENERICS_message]] ..
                                value)
    else
...
function GridNavigate(x, y)
    ...
    if not x and not y then
        ...
        if pcall(function()
            ...
            MangAdmin:LogAction(genericLogGenerator("logGM_gridNavigator", {
                ["value"] = newx .. " " .. newy
            }))
        else
